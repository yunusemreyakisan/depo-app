...
public class UrunIslemleri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urun_islemleri);
    ...
    private void btnUrunEkleIslevi() {
                ...
                btnUrunekle.setOnClickListener(view -> {
                    ...
                    if (TextUtils.isEmpty(urunadi) || TextUtils.isEmpty(urunMiktar) || TextUtils.isEmpty(urunKategori) || TextUtils.isEmpty(urundeposu)) {
                        Toast.makeText(UrunIslemleri.this, "Boş bırakılamaz.", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        mFirestore.collection("Kullanıcılar")
                                ...
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(UrunIslemleri.this, "Ürün başarıyla eklendi.", Toast.LENGTH_SHORT).show();
                                })
                                .addOnFailureListener(e -> Toast.makeText(UrunIslemleri.this, "Ürün eklenemedi, yeniden deneyin.", Toast.LENGTH_SHORT).show());
                    }
                });
